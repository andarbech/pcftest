...
export declare class BasePicker<T, P extends IBasePickerProps<T>> extends BaseComponent<P, IBasePickerState> implements IBasePicker<T> {
     ...
     */
    private _updateAndResolveValue(updatedValue, newSuggestions);
    /**
...
export declare const CheckBase: React.StatelessComponent<ICheckProps>;
...
export declare class CoachmarkBase extends BaseComponent<ICoachmarkProps, ICoachmarkState> implements ICoachmark {
    ...
    private _dismissOnLostFocus(ev);
    private _onKeyDown;
...
export declare class ComboBox extends BaseComponent<IComboBoxProps, IComboBoxState> {
     ...
     */
    private _buildDefaultSelectedKeys(defaultSelectedKey, selectedKey);
    private _buildSelectedKeys(selectedKey);
    private _getPreviewText(item);
    private _normalizeToString(value?);
    private _removeZeroWidthSpaces(value);
}
...
export declare const CompactPeoplePicker: React.StatelessComponent<IPeoplePickerProps>;
...
export declare class ContextualMenuBase extends BaseComponent<IContextualMenuProps, IContextualMenuState> {
    ...
    private _onRenderSubMenu(subMenuProps, defaultRender?);
    private _onRenderMenuList;
    private _renderMenuItem(item, index, focusableElementIndex, totalItemCount, hasCheckmarks, hasIcons);
    private _renderSectionItem(sectionItem, menuClassNames, index, hasCheckmarks, hasIcons);
...
export declare class DatePickerBase extends BaseComponent<IDatePickerProps, IDatePickerState> implements IDatePicker {
    ...
    focus(): void;
    reset(): void;
    private _setErrorMessage(setState, nextProps?);
    private _onSelectDate;
...
export declare const DetailsRowCheck: React.StatelessComponent<IDetailsRowCheckProps>;
...
export declare class DropdownBase extends React.Component<IDropdownInternalProps, IDropdownState> implements IDropdown {
    ...
    private _renderFocusableList(props);
...
export declare class FocusZone extends React.Component<IFocusZoneProps> implements IFocusZone {
     ...
     */
    private static _onKeyDownCapture(ev);
    ...
    private _onBlur;
    private _onMouseDown;
    private _setActiveElement(element, forceAlignment?);
    /**
    ...
    private _moveFocusPaging(isForward, useDefaultWrap?);
     ...
     */
    private _portalContainsElement(element);
}
 ...
 */
export declare const FontIcon: React.StatelessComponent<IFontIconProps>;
 ...
 */
export declare const getFontIcon: (iconName: string, className?: string | undefined, ariaLabel?: string | undefined) => React.ReactElement<any>;
...
export declare const getIconContent: (iconName?: string | undefined) => {
...
export declare class GroupedListBase extends BaseComponent<IGroupedListProps, IGroupedListState> implements IGroupedList {
    ...
    private _setGroupsCollapsedState(groups, isCollapsed);
...
export declare const GroupSpacer: React.SFC<IGroupSpacerProps>;
...
export declare class HoverCardBase extends BaseComponent<IHoverCardProps, IHoverCardState> implements IHoverCard {
    ...
    render(): JSX.Element;
    private _getTargetElement(target?);
 ...
 * {@docCategory Check}
 */
export declare interface ICheckStyleProps {
    /**
     * Accept theme prop.
     */
    theme: ITheme;
 ...
 * {@docCategory ChoiceGroup}
 */
export declare interface IChoiceGroupOption extends React.HTMLAttributes<HTMLElement | HTMLInputElement> {
    /**
 ...
 * {@docCategory ComboBox}
 */
export declare interface IComboBoxProps extends ISelectableDroppableTextProps<IComboBox> {
    /**
...
export declare const ImageIcon: React.StatelessComponent<IImageIconProps>;
 ...
 */
export declare interface ISelectableDroppableTextProps<TComponent, TListenerElement = TComponent> extends React.HTMLAttributes<TListenerElement> {
    /**
 ...
 * {@docCategory Stack}
 */
export declare interface IStackProps extends IStackSlots, IStyleableComponentProps<IStackProps, IStackTokens, IStackStyles>, React.HTMLAttributes<HTMLElement> {
    /**
 ...
 * {@docCategory Text}
 */
export declare interface ITextProps extends ITextSlots, IStyleableComponentProps<ITextProps, ITextTokens, ITextStyles>, React.HTMLAttributes<HTMLElement> {
    /**
...
export declare class KeytipLayerBase extends BaseComponent<IKeytipLayerProps, IKeytipLayerState> {
    ...
    private _getKtpExecuteTarget(currKtp);
    private _getKtpTarget(currKtp);
    /**
...
declare class KeytipTree {
    ...
    private _getParentID(fullSequence);
    private _getFullSequence(keytipProps);
    private _getNodeSequence(node);
    private _createNode(id, parentId, children, keytipProps, persisted?);
}
...
export declare class LinkBase extends BaseComponent<ILinkProps, any> implements ILink {
    ...
    focus(): void;
    private _onClick;
    private _adjustPropsForRootType(RootType, props);
    private _getRootType(props);
}
 ...
 */
export declare class List<T = any> extends BaseComponent<IListProps<T>, IListState<T>> implements IList {
    static defaultProps: {
        startIndex: number;
     ...
     */
    private _getPageHeight(itemIndex, visibleRect, itemsPerPage);
...
export declare const ListPeoplePicker: React.StatelessComponent<IPeoplePickerProps>;
...
export declare class NavBase extends React.Component<INavProps, INavState> implements INav {
    ...
    private _isGroupExpanded(group);
    private _toggleCollapsed(group);
}

export declare const NormalPeoplePicker: React.StatelessComponent<IPeoplePickerProps>;
...
declare class PanelBase extends BaseComponent<IPanelProps, IPanelState> implements IPanel {
    ...
    render(): JSX.Element | null;
    open(): void;
    dismiss: (ev?: React.SyntheticEvent<HTMLElement> | undefined) => void;
...
export declare const PeoplePickerItem: React.StatelessComponent<IPeoplePickerItemSelectedProps>;

export declare const PeoplePickerItemBase: (props: IPeoplePickerItemSelectedProps) => JSX.Element;

export declare const PeoplePickerItemSuggestion: React.StatelessComponent<IPeoplePickerItemSuggestionProps>;
...
export declare class ResizeGroupBase extends BaseComponent<IResizeGroupProps, IResizeGroupState> {
    ...
    remeasure(): void;
    private _afterComponentRendered(direction?);
    private _onResize();
}
...
export declare class ScrollablePaneBase extends BaseComponent<IScrollablePaneProps, IScrollablePaneState> implements IScrollablePane {
    ...
    getScrollPosition: () => number;
    syncScrollSticky: (sticky: Sticky) => void;
    private _checkStickyStatus(sticky);
...
export declare class SliderBase extends BaseComponent<ISliderProps, ISliderState> implements ISlider {
    ...
    private _getStyleUsingOffsetPercent(vertical, thumbOffsetPercent);
...
export declare class SuggestionsControl<T> extends BaseComponent<ISuggestionsControlProps<T>, ISuggestionsControlState<T>> {
     ...
     */
    private _selectNextItemOfItemType(itemType, currentIndex?);
    /**
     ...
     */
    private _selectPreviousItemOfItemType(itemType, currentIndex?);
    private _getCurrentIndexForType(itemType);
    private _getNextItemSectionType(itemType);
    private _getPreviousItemSectionType(itemType);
}
...
export declare const TagItem: React.StatelessComponent<ITagItemProps>;
...
export declare const TagItemSuggestion: React.StatelessComponent<ITagItemSuggestionProps>;
 ...
 * {@docCategory Callout}
 */
export declare type Target = Element | string | MouseEvent | IPoint | null;
...
export declare class TextFieldBase extends React.Component<ITextFieldProps, ITextFieldState> implements ITextField {
    static defaultProps: ITextFieldProps;
    private _id;
    private _descriptionId;
    private _labelId;
...
export declare class TooltipHostBase extends BaseComponent<ITooltipHostProps, ITooltipHostState> implements ITooltipHost {
    ...
    private _toggleTooltip(isTooltipVisible);
}
