...
exports.getPackageVersion = exports.ManifestProcessor = void 0;
...
class ManifestProcessor {
    ...
    processResources() {
        ...
        Object.keys(resources)
            .filter((resourceType) => resourceType !== constants.PLATFORM_LIBRARY_ELEM_NAME)
    ...
    stampApiVersion() {
        ...
        const apiVersion = getPackageVersion(pcfPackage, this.controlRoot);
        if (!apiVersion) {
